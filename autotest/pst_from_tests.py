...
def mf6_freyberg_ppu_hyperpars_thresh_gpr_invest(tmp_path):
    # make sure its avail before wasting more time
    ...
    pst.control_data.noptmax = -1
    pst.pestpp_options["ies_par_en"] = "prior.jcb"
    pst.pestpp_options["ies_num_reals"] = pst.npar * 2
    pst.pestpp_options["ies_subset_size"] = -10
    pst.pestpp_options["ies_no_noise"] = True
    #pst.pestpp_options["ies_bad_phi_sigma"] = 2.0
    pst.pestpp_options["overdue_giveup_fac"] = 100.0
    ...
    pst_fname = os.path.join(m_d,"freyberg.pst")
    gpr_t_d = os.path.join(pf.new_d+"_gpr")
    dv_pops = pd.read_csv(os.path.join(m_d,"freyberg.0.par.csv"),index_col=0)
    obs_pops = pd.read_csv(os.path.join(m_d,"freyberg.0.obs.csv"),index_col=0)
...
if __name__ == "__main__":
    ...
    mf6_freyberg_ppu_hyperpars_thresh_gpr_invest(".")
    #while True:

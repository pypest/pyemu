...
def freyberg():
    ...
    #pst.observation_data.loc[:,"weight"] /= 10.0
    pst.write("temp.pst")
    errcov = pyemu.Cov.from_obsweights(os.path.join("temp.pst"))

    ##
    sm = Assimilator(type='Smoother', iterate=False, mode='stochastic', pst=pst, parens=None, obs_ens=None,
                     num_slaves=20,parcov = parcov, obscov=errcov)
    sm.analysis()

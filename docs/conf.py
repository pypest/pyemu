...
# Inheritance diagram options can be changed here
inheritance_node_attrs = dict(shape='rectangle', fontsize=12)
...
project = 'pyEMU'
copyright = '2017, Jeremy White, Mike Fienen, John Doherty'
...
man_pages = [
    (master_doc, 'pyemu', 'pyEMU Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyEMU', 'pyEMU Documentation',
     author, 'pyEMU', 'One line description of project.',
     'Miscellaneous'),
]
